...
export const ManSvg = props => {
  return <svg {...props} t="1634112264684" className="icon" viewBox="0 0 1024 1024" version="1.1"
              xmlns="http://www.w3.org/2000/svg" p-id="22245" width="48" height="48">
    <path
      ...
      fill="#0091FF" p-id="22246"></path>
    <path d="M428 501.5c-55.1 0-99.7 44.8-99.7 100s44.6 100 99.7 100 99.7-44.8 99.7-100-44.7-100-99.7-100z"
          fill="#0091FF" p-id="22247"></path>
  </svg>
}

export const WoManSvg = props => {
  return <svg {...props} t="1634112429213" className="icon" viewBox="0 0 1024 1024" version="1.1"
              xmlns="http://www.w3.org/2000/svg" p-id="3690" width="48" height="48">
    <path
